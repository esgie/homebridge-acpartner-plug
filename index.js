...
module.exports = function(homebridge) {
    if(!isConfig(homebridge.user.configPath(), "platforms", "AcPartnerPlugPlatform")) {
        return;
    }
    ...
    homebridge.registerPlatform('homebridge-acpartner-plug', 'AcPartnerPlugPlatform', AcPartnerPlugPlatform, true);
}
...
function AcPartnerPlugPlatform(log, config, api) {
    if(null == config) {
        return;
    }
